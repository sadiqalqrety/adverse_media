"""Named-entity and semantic extractors for adverse media screening.

Two classes:
  NamedEntityExtractor  — fast, local spaCy NER pass to surface person mentions.
  SemanticExtractor     — deep Claude LLM analysis for match assessment & sentiment.
"""
...
class NamedEntityExtractor:
    ...
    allowing the SemanticExtractor to proceed unassisted.
    """
